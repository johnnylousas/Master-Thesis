...
class SampleGenerator:
    ...
    def __init__(self, nr_files: int = 10, nr_tests: int = 10, nr_commits: int = 10, nr_developers: int = 4):
        ...
        :parameter  nr_files: number of files in database
    ...
    def commit(self, nr_commits: int, team_size: int):
        """
        Simulate n number of commits
        :parameter  nr_commits: number of entries
                    team_size: number of authors
        :return: --- <class 'list'>
        """
        commits = list()
        authors = list()
    ...
    def check_prevalence(self):
        """
        Generates modified files list according to prevalence.
        :parameter
        :return: --- <class 'list'>
        """
        modified_files = list()
    ...
    def retrieve_metrics(self, nr_files, nr_tests, nr_commits, nr_developers):
        ...
        :param nr_developers: team size
        :param nr_commits: commit number
        :param nr_tests: test number
        :param nr_files: file number
        :return: --- <class 'dict'>
        """
