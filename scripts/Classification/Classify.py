...
class Classify:
    ...
    def logistic_regression(self, solver: str = 'liblinear', Cs: int = 10):
        print('#===============')
        model = LogisticRegression(solver=solver, C=Cs)
        ...
        return [model, trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]
    ...
    def decision_tree(self, min_samples_leaf: float = 0.05, max_depth: int = 5, criterion: str = 'entropy'):
        ...
        return [tree, trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]
    ...
    def random_forest(self, maxdepth: int = 20, estim: int = 40, minsplit: float = 0.2, criterion: str = 'entropy'):
        ...
        return [rf, trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]
    ...
    def xgboost(self, booster: str = 'gbtree'):
        ...
        return [xgb, trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]
        ...
        print(
            tabulate([['ANN', trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]],
                     headers=['Model',
                              ...
                              'Recall',
                              'fScore', 'Support'], tablefmt='orgtbl'))
        return [classifier, trn_loss, trn_acc, cnf_mtx, tst_acc, precision, recall, fscore, support]
